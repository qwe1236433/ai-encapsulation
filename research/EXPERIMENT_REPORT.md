...
### AUTO-EVAL 2026-04-18 08:50 UTC
- **feed digest sha256**: `823bb332becb003a…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 926; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.211, title_len=-0.171, body_len=0.070
- **null perm AUC** (single run, n_holdout=278): 0.5128
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 926; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=5.754, log1p_collect=1.186, log1p_share=0.378, title_len=-0.195, age_days=0.076, log1p_comment=0.074, body_len=0.014
- **null perm AUC** (single run, n_holdout=278): 0.5468


### AUTO-EVAL 2026-04-18 09:44 UTC
- **feed digest sha256**: `49ea3dc1f1ebde38…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1113; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.163, title_len=-0.190, body_len=0.069
- **null perm AUC** (single run, n_holdout=334): 0.5543
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1113; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=5.753, log1p_collect=1.167, log1p_share=0.371, title_len=-0.212, age_days=0.069, log1p_comment=0.066, body_len=0.016
- **null perm AUC** (single run, n_holdout=334): 0.5108


### AUTO-EVAL 2026-04-18 10:38 UTC
- **feed digest sha256**: `0d44528c234d8daf…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1164; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.157, title_len=-0.189, body_len=0.069
- **null perm AUC** (single run, n_holdout=350): 0.5017
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1164; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=5.755, log1p_collect=1.174, log1p_share=0.364, title_len=-0.207, age_days=0.068, log1p_comment=0.068, body_len=0.012
- **null perm AUC** (single run, n_holdout=350): 0.4711


### AUTO-EVAL 2026-04-18 11:32 UTC
- **feed digest sha256**: `c9b1892da3a2e648…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1264; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.135, title_len=-0.184, body_len=0.069
- **null perm AUC** (single run, n_holdout=380): 0.4296
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1264; **artifact holdout ROC-AUC**: 0.9995
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=5.751, log1p_collect=1.150, log1p_share=0.334, title_len=-0.201, age_days=0.066, log1p_comment=0.054, body_len=0.017
- **null perm AUC** (single run, n_holdout=380): 0.4297


### AUTO-EVAL 2026-04-18 13:21 UTC
- **feed digest sha256**: `435f2d203936b179…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1357; **artifact holdout ROC-AUC**: 0.9996
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.445, title_len=-0.146, body_len=0.014
- **null perm AUC** (single run, n_holdout=408): 0.4960
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1357; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.052, log1p_collect=1.222, log1p_share=0.237, title_len=-0.157, log1p_comment=0.066, body_len=-0.029, age_days=0.018
- **null perm AUC** (single run, n_holdout=408): 0.4828


### AUTO-EVAL 2026-04-18 14:15 UTC
- **feed digest sha256**: `459475711f699bbe…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1379; **artifact holdout ROC-AUC**: 0.9981
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.437, title_len=-0.146, body_len=0.015
- **null perm AUC** (single run, n_holdout=414): 0.5266
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1379; **artifact holdout ROC-AUC**: 0.9981
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.079, log1p_collect=1.209, log1p_share=0.227, title_len=-0.155, log1p_comment=0.060, body_len=-0.028, age_days=0.020
- **null perm AUC** (single run, n_holdout=414): 0.5331


### AUTO-EVAL 2026-04-18 15:09 UTC
- **feed digest sha256**: `3e7ed9071c497e6f…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1461; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.441, title_len=-0.147, body_len=0.014
- **null perm AUC** (single run, n_holdout=439): 0.5641
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1461; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.084, log1p_collect=1.214, log1p_share=0.245, title_len=-0.163, log1p_comment=0.069, body_len=-0.026, age_days=0.023
...
### AUTO-EVAL 2026-04-19 04:21 UTC
- **feed digest sha256**: `9454887c039dc300…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1519; **artifact holdout ROC-AUC**: 0.9999
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.446, title_len=-0.157, body_len=0.045
- **null perm AUC** (single run, n_holdout=456): 0.4322
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1519; **artifact holdout ROC-AUC**: 0.9994
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.112, log1p_collect=1.206, log1p_share=0.175, title_len=-0.168, log1p_comment=0.033, age_days=0.012, body_len=0.009
- **null perm AUC** (single run, n_holdout=456): 0.4460


### AUTO-EVAL 2026-04-19 05:16 UTC
- **feed digest sha256**: `db7c0b586b067629…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1616; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.443, title_len=-0.160, body_len=0.044
- **null perm AUC** (single run, n_holdout=485): 0.5677
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1616; **artifact holdout ROC-AUC**: 0.9997
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.110, log1p_collect=1.192, log1p_share=0.165, title_len=-0.163, log1p_comment=0.022, age_days=0.011, body_len=0.008
- **null perm AUC** (single run, n_holdout=485): 0.5107


### AUTO-EVAL 2026-04-19 06:10 UTC
- **feed digest sha256**: `dc722c9dcfe683ed…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 1718; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.401, title_len=-0.162, body_len=0.045
- **null perm AUC** (single run, n_holdout=516): 0.4788
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 1718; **artifact holdout ROC-AUC**: 0.9997
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.078, log1p_collect=1.176, log1p_share=0.172, title_len=-0.170, log1p_comment=0.023, body_len=0.015, age_days=0.011
...
### AUTO-EVAL 2026-04-19 12:29 UTC
- **feed digest sha256**: `81db1c8d1191a7c1…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 2698; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=7.046, title_len=-0.070, body_len=0.040
- **null perm AUC** (single run, n_holdout=810): 0.4333
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 2698; **artifact holdout ROC-AUC**: 0.9998
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.540, log1p_collect=1.361, log1p_share=0.237, title_len=-0.094, log1p_comment=0.034, body_len=-0.019, age_days=-0.015
- **null perm AUC** (single run, n_holdout=810): 0.4925


### AUTO-EVAL 2026-04-19 13:24 UTC
- **feed digest sha256**: `178aae0121b01dd5…`（全长 64 hex）
- **eval**: `research/artifacts/eval_auto_baseline_v0.json`
- **n_samples**: 2873; **artifact holdout ROC-AUC**: 1.0000
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=7.240, title_len=-0.082, body_len=0.030
- **null perm AUC** (single run, n_holdout=862): 0.5081
- **eval**: `research/artifacts/eval_auto_baseline_v1.json`
- **n_samples**: 2873; **artifact holdout ROC-AUC**: 0.9998
- **warnings**: `holdout_auc_very_high_check_overfit`
- **std coef (top by |coef|)**: log1p_like=6.760, log1p_collect=1.294, log1p_share=0.227, title_len=-0.120, log1p_comment=0.106, body_len=-0.024, age_days=-0.020
- **null perm AUC** (single run, n_holdout=862): 0.4789
